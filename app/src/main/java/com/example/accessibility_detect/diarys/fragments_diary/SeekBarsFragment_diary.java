...
public class SeekBarsFragment_diary extends Fragment implements SeekBar.OnSeekBarChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.diary_seek_bars, container, false);

        db = appDatabase.getDatabase(getActivity());

        nextOrFinishButton = rootView.findViewById(R.id.diary_nextOrFinishButton);
        questionSKTypeTextView = rootView.findViewById(R.id.diary_questionSKTypeTextView);
        seekBarsLinearLayout = (LinearLayout) rootView.findViewById(R.id.diary_seekBarsLinearLayout);
...
//                seekBarTypeQuestion.setQuestionName("針對「" + option +"」，請問你看到新聞多久後查證？（若立即查證或搜尋資料，請填0分0秒）？");
//            }
//        }
        ...
        Observable.just(data)
                .map(new Function<String[], Object>() {
                    ...
                    public Object apply(String[] data1) throws Exception {
                        return SeekBarsFragment_diary.this.insertingInDb(data1);
                    }
                })
