 ...
 */
public class RadioBoxesFragment_test extends Fragment
{
    ...
    String notiId = "";
    public RadioBoxesFragment_test()
    {
...
//                    mContext.setResult(Activity.RESULT_OK, returnIntent);
                    ...
                    if (Q7Answer == 0) {//是
                        ((QuestionActivity_test) mContext).nextQuestion(4);
                    }else {
                        ((QuestionActivity_test) mContext).nextQuestion(1);
                    }
                }
        ...
        Observable.just(data)
                .map(new Function<String[], Object>() {
                    ...
                    public Object apply(String[] data1) throws Exception {
                        return RadioBoxesFragment_test.this.insertingInDbForOther(data1);
                    }
                })
                .subscribeOn(Schedulers.io())
                .subscribe();
    ...
    private void insertChoiceInDatabase(String[] data)
    {
        Observable.just(data)
                .map(new Function<String[], Object>() {
                    @Override
                    public Object apply(String[] data1) throws Exception {
                        return RadioBoxesFragment_test.this.insertingInDb(data1);
                    }
                })
                .subscribeOn(Schedulers.io())
                .subscribe();
...
//    }
    ...
    public void onActivityCreated(Bundle savedInstanceState)
    {
        ...
        try {
            ...
            List<AnswerOptions_test> choices = radioButtonTypeQuestion.getAnswerOptions();
            radioButtonArrayList.clear();

            for (AnswerOptions_test choice : choices)
            {
                    ...
                    rb.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                        ...
                        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                            if (screenVisible) {
                                ...
                                RadioBoxesFragment_test.this.saveActionsOfRadioBox();
                            }
                        }
                    });
                }
