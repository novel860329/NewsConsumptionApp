 ...
 */
public class CheckBoxesFragment_test extends Fragment
{
    ...
    String notiId = "";
    public CheckBoxesFragment_test()
    {
...
//        }
        ...
        Observable.just(data)
                .map(new Function<String[], Object>() {
                    ...
                    public Object apply(String[] data1) throws Exception {
                        return CheckBoxesFragment_test.this.insertingInDbForOther(data1);
                    }
                })
                .subscribeOn(Schedulers.io())
                .subscribe();
    ...
    private void insertAnswerInDatabase(String[] data)
    {
        Observable.just(data)
                .map(new Function<String[], Object>() {
                    @Override
                    public Object apply(String[] data1) throws Exception {
                        return CheckBoxesFragment_test.this.insertingInDb(data1);
                    }
                })
                .subscribeOn(Schedulers.io())
                .subscribe();
    ...
    public void onActivityCreated(Bundle savedInstanceState)
    {
        ...
        QuestionsItem_test checkBoxTypeQuestion = null;
        String extraInfo = "";
...
//        }
        ...
        List<AnswerOptions_test> checkBoxChoices = Objects.requireNonNull(checkBoxTypeQuestion).getAnswerOptions();
...
//        }
        ...
        for (AnswerOptions_test choice : checkBoxChoices)
        {
...
//                });
                ...
                checkBox.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view1) {
                        ...
                        clickedCheckBoxPosition = checkBoxArrayList.indexOf(buttonView);
                        CheckBoxesFragment_test.this.saveActionsOfCheckBox();
                    }
                });
...
//            }
    ...
    private void preClick(long lastESM_time){
        for (int i = 0; i < checkBoxArrayList.size(); i++) {
            CheckBox checkBox = checkBoxArrayList.get(i);
            String AppMapping = "";
            if (checkBox.getText().equals("新聞App")) {
                AppMapping = "NewsApp";
            ...
            if (AppMapping.equals("NewsApp") || AppMapping.equals("Notification") || AppMapping.equals("googleNews")) {
                checkBox.setChecked(true);
