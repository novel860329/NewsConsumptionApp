...
public class SeekBarsFragment_test extends Fragment implements SeekBar.OnSeekBarChangeListener {
...
//                    pageRecord.add(currentPagePosition);
    ...
    public void onActivityCreated(Bundle savedInstanceState)
    {
        ...
        String extraInfo = "";
        QuestionsItem_test seekBarTypeQuestion = null;
        ...
        List<AnswerOptions_test> seekBarChoices = Objects.requireNonNull(seekBarTypeQuestion).getAnswerOptions();

        seekBarsArrayList.clear();

        for (AnswerOptions_test choice : seekBarChoices) {
        ...
        Observable.just(data)
                .map(new Function<String[], Object>() {
                    ...
                    public Object apply(String[] data1) throws Exception {
                        return SeekBarsFragment_test.this.insertingInDb(data1);
                    }
                })
