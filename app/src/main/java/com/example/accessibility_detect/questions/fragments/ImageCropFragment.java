...
public class ImageCropFragment extends Fragment
{
    ...
    private static QuestionsItem imageCropTypeQuestion;
        ...
        Observable.just(data)
                .map(new Function<String[], Object>() {
                    ...
                    public Object apply(String[] data1) throws Exception {
                        return ImageCropFragment.this.insertingInDbForOther(data1);
                    }
                })
                .subscribeOn(Schedulers.io())
                .subscribe();
    ...
    private void insertChoiceInDatabase(String[] data)
    {
        Observable.just(data)
                .map(new Function<String[], Object>() {
                    @Override
                    public Object apply(String[] data1) throws Exception {
                        return ImageCropFragment.this.insertingInDb(data1);
                    }
                })
                .subscribeOn(Schedulers.io())
                .subscribe();
...
//            imageCropTypeQuestion = getArguments().getParcelable("question"); //type = image crop
            imageCropTypeQuestion = QuestionActivity.questionsItems.get(getArguments().getInt("page_position"));
