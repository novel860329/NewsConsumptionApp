...
public class ChoosePictureFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        questionRBTypeTextView = rootView.findViewById(R.id.questionTypeTextView);
        imageShow = (ImageView)rootView.findViewById(R.id.image_show_frag);
...
//                }
                ...
                String[] data = new String[]{ChooseImage, questionId, String.valueOf(0)};
...
//            startActivity(ESMintent);
            ...
            mImages.clear();
            mCheck.clear();
            ((QuestionActivity) mContext).nextQuestion(6);
        ...
        Observable.just(data)
                .map(new Function<String[], Object>() {
                    ...
                    public Object apply(String[] data1) throws Exception {
                        return ChoosePictureFragment.this.insertingInDb(data1);
                    }
                })
