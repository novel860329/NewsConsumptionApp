...
//    public String NotificationUrl;
    ...
    public LocationDataRecord(float latitude, float longitude, float Accuracy, float Altitude, float Speed,
                              float Bearing, String Provider, String sessionid, long phone_sessionid,
                              String screenshot) {
