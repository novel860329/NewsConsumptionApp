   ...
   static String TAG="mc";
    ...
    static String[]KeyWords = new String[]{"answer questions",
           ...
           "image label verification","sentiment evaluation","handwriting recognition",
            ...
            "clearly identificable in the photo?","discover","submit", "yes", "no","edit","skip","有人提出問題","你的每日貢獻","覺得","怎麼樣"," 你的評論","分享","幫助其他人瞭解這個地方","留下評論","評論","相片","你搭乘的公車有多擁擠","幫助其他"
            ,"協助","幫忙","解答"};
    ...
    static String[]blackListCH = new String[]{
            ...
            "電話","向下拖曳即可移除",
            //"在這裡搜尋","餐廳","咖啡"," 景點","更多","餐點價格低廉","本地人常去的用餐地點","適合團體用餐","探索","通勤","為你推薦","出發",
            // for map searching or timeline
            "were you here","am","pm","commute"
    ...
    public static  String[] localGuidePage = new String[]{
               "在地嚮導","問與答"};
    public static  String[] navigation = new String[]{
            "開始","接下來","路線等資訊"};
    ...
    public static String [] possibleMCTitle = new String []{
        "覺得","怎麼樣","有人提出問題","新增相片","每日貢獻"," 幫助"
    };
...
//    public static boolean ifNotiTitleMCTask(Context context,String str){
//        str = str.toLowerCase();
//        for(String temp:strictKeyWords){
...
//    }
    ...
    public static boolean ifNotiTitleMCTask(Context context, String str){
        str = str.toLowerCase();
        for(String temp:possibleMCTitle){
            if(str.contains(temp)){
                // showToastMethod(context,"strictKey : "+temp);
                return true;
            }
    ...
    public static  boolean enterLocalGuideOrGCrowdsource(Context context,String str,int packCode){
        str = str.toLowerCase();
        if (packCode == 5){
            return true;
        }
        for(String temp:localGuidePage){
            for(String navStr : navigation){
                if(str.contains(temp) && !str.contains(navStr)){
                    return true;
                }
    ...
    public static final class AppCode {
        ...
        public static final int NEWSCONSUMPTION = 18;
    ...
    public static final class ApplicationPackageNames {
        ...
        public static final String NEWSCONSUMPTION = "com.example.accessibility_detect";
    ...
    public static String matchAppName(int code){
        ...
        }else return Constants.NON_TARGET_APP;
    }
    public static int matchAppCode(String pack) {
        ...
        else if (pack.contains(ApplicationPackageNames.NEWSCONSUMPTION)){
            return AppCode.NEWSCONSUMPTION;
        }
        else
